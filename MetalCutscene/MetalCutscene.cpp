// MetalCutscene.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"
#include "MetalCutscene.h"
#include "easyhook.h"
#include <string>
#include <iostream>
#include <Windows.h>
...
// see MetalCutscene.h for the class definition
CMetalCutscene::CMetalCutscene()
{
    return;
}
